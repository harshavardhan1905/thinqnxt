...
<head>
    ...
    <title>Become a Teacher - Best Data Analytics Courses in Hyderabad</title>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-inner text-center">
                    <h2 class="title">Become a Teacher</h2>
                    <ul class="page-list">
                        <li class="rbt-breadcrumb-item"><a href="index.php">Home</a></li>
                        <li>
                            <div class="icon-right"><i class="feather-chevron-right"></i></div>
                        </li>
                        <li class="rbt-breadcrumb-item active">Become a Teacher</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="swiper rbt-gif-banner-area rbt-arrow-between">
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="thumbnail">
                                    <a href="#">
                                        <img class="rbt-radius w-100" src="assets/images/banner/gallery-banner-03.jpg"
                                            alt="Banner Images">
                                    </a>
                                </div>
                            </div>
