...
<head>
    ...
    <title>Home - Best Data Analytics Courses in Hyderabad</title>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="rbt-card variation-01 rbt-hover">
                                            ...
                                            <div class="rbt-card-body">
                                                ...
                                                <h4 class="rbt-card-title"><a href="course-details.php">React</a>
                                                </h4>
                                                ...
                                                <div class="rbt-card-bottom">
                                                    ...
                                                    <a class="rbt-btn-link" href="course-details.php">Learn More<i
                                                            class="feather-arrow-right"></i></a>
                                                </div>
                                            </div>
                                        </div>
...
<div class="col-lg-3 col-md-6 col-sm-6 col-12">
    <a class="rbt-cat-box rbt-cat-box-1 text-center" href="course-filter-one-toggle.php">
        <div class="inner">
            <div class="icons">
...
<div class="scroll-animation-wrapper no-overlay mt--30">
            ...
            <div class="single-slide">
                <div class="rbt-card event-grid-card variation-01 rbt-hover">
                    ...
                    <div class="rbt-card-body">
                        ...
                        <h4 class="rbt-card-title"><a href="event-details.php">Painting Art Contest 2020 for histudy
                                Clud</a></h4>
            ...
            <div class="single-slide">
                <div class="rbt-card event-grid-card variation-01 rbt-hover">
                    ...
                    <div class="rbt-card-body">
                        ...
                        <h4 class="rbt-card-title"><a href="event-details.php">Elegant Light Box Paper Cut Dioramas in
                                UK</a></h4>
            ...
            <div class="single-slide">
                <div class="rbt-card event-grid-card variation-01 rbt-hover">
                    ...
                    <div class="rbt-card-body">
                        ...
                        <h4 class="rbt-card-title"><a href="event-details.php">Most Effective Ways for Education's
                                Problem</a></h4>
            ...
            <div class="single-slide">
                <div class="rbt-card event-grid-card variation-01 rbt-hover">
                    ...
                    <div class="rbt-card-body">
                        ...
                        <h4 class="rbt-card-title"><a href="event-details.php">International Education Fair 2025</a>
                        </h4>
    ...
    <div class="col-lg-5">
        ...
        <ul class="rbt-team-tab-thumb nav nav-tabs" id="myTab" role="tablist">
            <li>
                <a class="active" id="team-tab1-tab" data-bs-toggle="tab" data-bs-target="#team-tab1" role="tab"
                    aria-controls="team-tab1" aria-selected="true">
                    <div class="rbt-team-thumbnail">
                        <div class="thumb">
                            <img src="assets/images/team/team-01.jpg" alt="Testimonial Images">
                        </div>
            ...
            <li>
                <a id="team-tab2-tab" data-bs-toggle="tab" data-bs-target="#team-tab2" role="tab" aria-controls="team-tab2"
                    aria-selected="false">
                    <div class="rbt-team-thumbnail">
                        <div class="thumb">
                            <img src="assets/images/team/team-02.jpg" alt="Testimonial Images">
            ...
            <li>
                <a id="team-tab3-tab" data-bs-toggle="tab" data-bs-target="#team-tab3" role="tab" aria-controls="team-tab3"
                    aria-selected="false">
                    <div class="rbt-team-thumbnail">
                        <div class="thumb">
                            <img src="assets/images/team/team-03.jpg" alt="Testimonial Images">
            ...
            <li>
                <a id="team-tab4-tab" data-bs-toggle="tab" data-bs-target="#team-tab4" role="tab" aria-controls="team-tab4"
                    aria-selected="false">
                    <div class="rbt-team-thumbnail">
                        <div class="thumb">
                            <img src="assets/images/team/team-04.jpg" alt="Testimonial Images">
            ...
            <li>
                <a id="team-tab5-tab" data-bs-toggle="tab" data-bs-target="#team-tab5" role="tab" aria-controls="team-tab5"
                    aria-selected="false">
                    <div class="rbt-team-thumbnail">
                        <div class="thumb">
                            <img src="assets/images/team/team-05.jpg" alt="Testimonial Images">
            ...
            <li>
                <a id="team-tab6-tab" data-bs-toggle="tab" data-bs-target="#team-tab6" role="tab" aria-controls="team-tab6"
                    aria-selected="false">
                    <div class="rbt-team-thumbnail">
                        <div class="thumb">
                            <img src="assets/images/team/team-06.jpg" alt="Testimonial Images">
...
<div class="row row--15">
    ...
    <div class="col-lg-6 col-md-12 col-sm-12 col-12 mt--30" data-sal-delay="150" data-sal="slide-up"
        ...
        <div class="rbt-card variation-02 height-330 rbt-hover">
            ...
            <div class="rbt-card-body">
                <h3 class="rbt-card-title"><a href="blog-details.php">React</a></h3>
                <p class="rbt-card-text">It is a long established fact that a reader.</p>
                <div class="rbt-card-bottom">
                    <a class="transparent-button" href="blog-details.php">Learn More<i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg"><g stroke="#27374D" fill="none" fill-rule="evenodd"><path d="M10.614 0l5.629 5.629-5.63 5.629"/><path stroke-linecap="square" d="M.663 5.572h14.594"/></g></svg></i></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-6 col-md-12 col-sm-12 col-12 mt--30" data-sal-delay="150" data-sal="slide-up"
        ...
        <div class="rbt-card card-list variation-02 rbt-hover">
            ...
            <div class="rbt-card-body">
                <h5 class="rbt-card-title"><a href="blog-details.php">Why Is Education So Famous?</a></h5>
                <div class="rbt-card-bottom">
                    <a class="transparent-button" href="blog-details.php">Read Article<i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg"><g stroke="#27374D" fill="none" fill-rule="evenodd"><path d="M10.614 0l5.629 5.629-5.63 5.629"/><path stroke-linecap="square" d="M.663 5.572h14.594"/></g></svg></i></a>
                </div>
            </div>
        </div>
        <!-- End Single Card  -->
        ...
        <div class="rbt-card card-list variation-02 rbt-hover mt--30">
            ...
            <div class="rbt-card-body">
                <h5 class="rbt-card-title"><a href="blog-details.php">Difficult Things About Education.</a></h5>
                <div class="rbt-card-bottom">
                    <a class="transparent-button" href="blog-details.php">Read Article<i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg"><g stroke="#27374D" fill="none" fill-rule="evenodd"><path d="M10.614 0l5.629 5.629-5.63 5.629"/><path stroke-linecap="square" d="M.663 5.572h14.594"/></g></svg></i></a>
                </div>
            </div>
        ...
        <div class="rbt-card card-list variation-02 rbt-hover mt--30">
            ...
            <div class="rbt-card-body">
                <h5 class="rbt-card-title"><a href="blog-details.php">Education Is So Famous, But Why?</a></h5>
                <div class="rbt-card-bottom">
                    <a class="transparent-button" href="blog-details.php">Read Article<i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg"><g stroke="#27374D" fill="none" fill-rule="evenodd"><path d="M10.614 0l5.629 5.629-5.63 5.629"/><path stroke-linecap="square" d="M.663 5.572h14.594"/></g></svg></i></a>
                </div>
            </div>
