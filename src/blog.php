                    ...
                    <div class="rbt-card variation-02 height-330 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            ...
                            <div class="rbt-card-bottom">
                                <a class="transparent-button" href="blog-details.php">Learn More<i>@@include('icons/arrow-right.php')</i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-12" data-sal-delay="150" data-sal="slide-up"
                    ...
                    <div class="rbt-card card-list variation-02 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            ...
                            <div class="rbt-card-bottom">
                                <a class="transparent-button" href="blog-details.php">Read Article<i>@@include('icons/arrow-right.php')</i></a>
                            </div>
                        </div>
                    </div>
                    <!-- End Single Card  -->
