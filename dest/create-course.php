...
<head>
    ...
    <title>Create Course - Best Data Analytics Courses in Hyderabad</title>
    <meta name="robots" content="noindex, follow" >
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="https://thinqnxt.com/wp-content/uploads/2025/04/cropped-Thinq-nxt-icon-black-1.png">
                    ...
                    <div class="row row--15 home-plesentation-wrapper single-dropdown-menu-presentation">
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="01-main-demo.php"><img src="assets/images/splash/demo/h1.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="01-main-demo.php">Home Demo <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="12-marketplace.php"><img src="assets/images/splash/demo/h12.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="12-marketplace.php">Marketplace <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="04-kindergarten.php"><img src="assets/images/splash/demo/h4.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="04-kindergarten.php">kindergarten <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <!-- End Single Demo  -->
                         ...
                         <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="13-university-classic.php"><img src="assets/images/splash/demo/h13.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="13-university-classic.php">University Classic <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="14-home-elegant.php"><img src="assets/images/splash/demo/h14.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="14-home-elegant.php">Home Elegant <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="09-gym-coaching.php"><img src="assets/images/splash/demo/h9.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="09-gym-coaching.php">Gym Coaching <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="03-online-school.php"><img src="assets/images/splash/demo/h3.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="03-online-school.php">Online School <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="06-university-status.php"><img src="assets/images/splash/demo/h6.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="06-university-status.php">University Status <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="15-home-technology.php"><img src="assets/images/splash/demo/h15.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="15-home-technology.php">Home Technology <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="07-instructor-portfolio.php"><img src="assets/images/splash/demo/h7.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="07-instructor-portfolio.php">Instructor Portfolio <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="08-language-academy.php"><img src="assets/images/splash/demo/h8.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="08-language-academy.php">Language Academy <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="11-single-course.php"><img src="assets/images/splash/demo/h11.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="11-single-course.php">Single Course <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="10-online-course.php"><img src="assets/images/splash/demo/h10.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="10-online-course.php">Online Course <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="05-classic-lms.php"><img src="assets/images/splash/demo/h5.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="05-classic-lms.php">Classic Lms <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="02-course-school.php"><img src="assets/images/splash/demo/h2.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="02-course-school.php">Course School <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="16-udemy-affiliate.php"><img src="assets/images/splash/demo/h16.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="16-udemy-affiliate.php">Udemy Affiliate <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="17-online-academy.php"><img src="assets/images/splash/demo/h17.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="17-online-academy.php">Online Academy <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="18-instructors-coaches.php"><img src="assets/images/splash/demo/h18.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="18-instructors-coaches.php">Instructor Coaches <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="19-modern-university.php"><img src="assets/images/splash/demo/h19.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="19-modern-university.php">Modern University <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="20-multilingual.php"><img src="assets/images/splash/demo/h20.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="20-multilingual.php">Multilingual <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="21-art-design-school.php"><img src="assets/images/splash/demo/h21.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="21-art-design-school.php">Art Design School <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="22-wishlist.php"><img src="assets/images/splash/demo/h22.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="22-wishlist.php">Wishlist <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="23-coaching.php"><img src="assets/images/splash/demo/h23.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="23-coaching.php">Coaching <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="24-health-wellness-institute.php"><img src="assets/images/splash/demo/h24.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="24-health-wellness-institute.php">Health Institute <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="25-life-coach.php"><img src="assets/images/splash/demo/h25.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="25-life-coach.php">Life Coach <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 col-xl-2 col-xxl-2 col-md-12 col-sm-12 col-12 single-mega-item">
                            <div class="demo-single">
                                <div class="inner">
                                    <div class="thumbnail">
                                        <a href="26-islamic-center.php"><img src="assets/images/splash/demo/h26.jpg" alt="Demo Images"></a>
                                    </div>
                                    <div class="content">
                                        <h4 class="title"><a href="26-islamic-center.php">Islamic Center <span class="btn-icon"><i class="feather-arrow-right"></i></span></a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row row--15">
                        <div class="col-lg-12 col-xl-6 col-xxl-6 single-mega-item">
                            ...
                            <ul class="mega-menu-item">
                                <li><a href="course-filter-one-toggle.php">Filter One Toggle</a></li>
                                <li><a href="course-filter-one-open.php">Filter One Open</a></li>
                                <li><a href="course-filter-two-toggle.php">Filter Two Toggle</a></li>
                                <li><a href="course-filter-two-open.php">Filter Two Open</a></li>
                                <li><a href="course-with-tab.php">Course With Tab</a></li>
                                <li><a href="course-with-tab-two.php">Course With Tab Two</a></li>
                                <li><a href="course-card-2.php">Course Card Two</a></li>
                            </ul>
                        </div>
                        <div class="col-lg-12 col-xl-6 col-xxl-6 single-mega-item">
                            <h3 class="rbt-short-title">Course Layout</h3>
                            <ul class="mega-menu-item">
                                <li><a href="course-card-3.php">Course Card Three</a></li>
                                <li><a href="course-masonry.php">Course Masonry</a></li>
                                <li><a href="course-with-sidebar.php">Course With Sidebar</a></li>
                                <li><a href="course-details.php">Course Details</a></li>
                                <li><a href="course-details-2.php">Course Details Two</a></li>
                                <li><a href="lesson.php">Course Lesson <span class="rbt-badge-card">New</span></a></li>
                                <li><a href="create-course.php">Create Course <span class="rbt-badge-card">New</span></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="row">
            ...
            <ul class="submenu">
                <li class="has-dropdown"><a href="#">Instructor Dashboard</a>
                    <ul class="submenu">
                        ...
                        <li><a href="instructor-enrolled-courses.php">Enrolled Courses</a></li>
                        <li><a href="instructor-wishlist.php">Wishlist</a></li>
                        <li><a href="instructor-reviews.php">Reviews</a></li>
                        <li><a href="instructor-my-quiz-attempts.php">My Quiz Attempts</a></li>
                        <li><a href="instructor-order-history.php">Order History</a></li>
                        <li><a href="instructor-course.php">My Course</a></li>
                        <li><a href="instructor-announcements.php">Announcements</a></li>
                        <li><a href="instructor-quiz-attempts.php">Quiz Attempts</a></li>
                        <li><a href="instructor-assignments.php">Assignments</a></li>
                        <li><a href="instructor-settings.php">Settings</a></li>
                    </ul>
                </li>
                <li class="has-dropdown"><a href="#">Student Dashboard</a>
                    <ul class="submenu">
                        ...
                        <li><a href="student-wishlist.php">Wishlist</a></li>
                        <li><a href="student-reviews.php">Reviews</a></li>
                        <li><a href="student-my-quiz-attempts.php">My Quiz Attempts</a></li>
                        <li><a href="student-order-history.php">Order History</a></li>
                ...
                <div class="wrapper">
                    <div class="row row--15">
                        <div class="col-lg-12 col-xl-3 col-xxl-3 single-mega-item">
                            ...
                            <ul class="mega-menu-item">
                                <li><a href="about-us-01.php">About Us</a></li>
                                <li><a href="about-us-02.php">About Us 02</a></li>
                                <li><a href="event-grid.php">Event Grid</a></li>
                                <li><a href="event-list.php">Event List</a></li>
                                <li><a href="event-sidebar.php">Event Sidebar</a></li>
                                <li><a href="event-details.php">Event Details</a></li>
                                <li><a href="academy-gallery.php">Academy Gallery</a></li>
                        ...
                        <div class="col-lg-12 col-xl-3 col-xxl-3 single-mega-item">
                            ...
                            <ul class="mega-menu-item">
                                <li><a href="shop.php">Shop <span class="rbt-badge-card">Sale Anything</span></a></li>
                ...
                <div class="wrapper">
                    <div class="row row--15 single-dropdown-menu-presentation">
                        <div class="col-lg-4 col-xxl-4 single-mega-item">
                            <ul class="mega-menu-item">
                                <li><a href="style-guide.php">Style Guide <span class="rbt-badge-card">Hot</span></a></li>
                                <li><a href="accordion.php">Accordion</a></li>
                                <li><a href="advancetab.php">Advance Tab</a></li>
                                <li><a href="about.php">About <span class="rbt-badge-card">New</span></a></li>
                        ...
                        <div class="col-lg-4 col-xxl-4 single-mega-item">
                            <ul class="mega-menu-item">
                                ...
                                <li><a href="counterup.php">Counter</a></li>
                                <li><a href="category.php">Categories</a></li>
                                <li><a href="header.php">Header Style</a></li>
                                <li><a href="newsletter.php">Newsletter</a></li>
                                <li><a href="team.php">Team</a></li>
                                <li><a href="social.php">Social</a></li>
                                <li><a href="list-style.php">List Style</a></li>
                                <li><a href="#">& More Coming</a></li>
                            </ul>
                        </div>
                        ...
                        <div class="col-lg-4 col-xxl-4 single-mega-item">
                            <ul class="mega-menu-item">
                                ...
                                <li><a href="split.php">Split Area</a></li>
                                <li><a href="search.php">Search Style</a></li>
                                <li><a href="instagram.php">Instagram Style</a></li>
                                <li><a href="#">& More Coming</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="row row--15">
                        <div class="col-lg-12 col-xl-4 col-xxl-4 single-mega-item">
                            ...
                            <ul class="mega-menu-item">
                                ...
                                <li><a href="blog-grid-minimal.php">Blog Grid Minimal</a></li>
                        ...
                        <div class="col-lg-12 col-xl-4 col-xxl-4 single-mega-item">
                            <h3 class="rbt-short-title">Get Started</h3>
                            <ul class="mega-menu-item">
                                <li><a href="post-format-quote.php">Post Format Quote</a></li>
                                <li><a href="post-format-audio.php">Post Format Audio</a></li>
    ...
    <div class="inner">
        <div class="rbt-admin-profile">
            ...
            <div class="admin-info">
                ...
                <a class="rbt-btn-link color-primary" href="profile.php">View Profile</a>
            </div>
        </div>
        <ul class="user-list-wrapper">
            ...
            <li>
                <a href="instructor-enrolled-courses.php">
                    <i class="feather-shopping-bag"></i>
                    <span>Enrolled Courses</span>
                </a>
            </li>
            <li>
                <a href="instructor-wishlist.php">
                    <i class="feather-heart"></i>
                    <span>Wishlist</span>
                </a>
            </li>
            <li>
                <a href="instructor-reviews.php">
                    <i class="feather-star"></i>
                    <span>Reviews</span>
                </a>
            </li>
            <li>
                <a href="instructor-my-quiz-attempts.php">
                    <i class="feather-list"></i>
                    <span>My Quiz Attempts</span>
                </a>
            </li>
            <li>
                <a href="instructor-order-history.php">
                    <i class="feather-clock"></i>
                    <span>Order History</span>
                </a>
            </li>
            <li>
                <a href="instructor-quiz-attempts.php">
        ...
        <ul class="user-list-wrapper">
            <li>
                <a href="instructor-settings.php">
        ...
        <div class="row g-4 pt--30 pb--60">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                <div class="rbt-card variation-01 rbt-hover">
                    ...
                    <div class="rbt-card-body">
                        <h5 class="rbt-card-title"><a href="course-details.php">React Js</a>
                        </h5>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                <div class="rbt-card variation-01 rbt-hover">
                    ...
                    <div class="rbt-card-body">
                        <h5 class="rbt-card-title"><a href="course-details.php">Java Program</a>
                        </h5>
                        <div class="rbt-review">
                            <div class="rating">
                                <i class="fas fa-star"></i>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 col-12">
                <div class="rbt-card variation-01 rbt-hover">
                    ...
                    <div class="rbt-card-body">
                        <h5 class="rbt-card-title"><a href="course-details.php">Web Design</a>
                        </h5>
                        <div class="rbt-review">
                            <div class="rating">
                                <i class="fas fa-star"></i>
            ...
            <ul class="rbt-minicart-wrapper">
                <li class="minicart-item">
                    ...
                    <div class="product-content">
                        <h6 class="title"><a href="single-product.php">Miracle Morning</a></h6>
                ...
                <li class="minicart-item">
                    ...
                    <div class="product-content">
                        <h6 class="title"><a href="single-product.php">Happy Strong</a></h6>
                ...
                <li class="minicart-item">
                    ...
                    <div class="product-content">
                        <h6 class="title"><a href="single-product.php">Rich Dad Poor Dad</a></h6>
                ...
                <li class="minicart-item">
                    ...
                    <div class="product-content">
                        <h6 class="title"><a href="single-product.php">Momentum Theorem</a></h6>
...
<a class="close_side_menu" href="javascript:void(0);"></a>
    ...
    <main class="rbt-main-wrapper">
                            ...
                            <div class="accordion" id="tutionaccordionExamplea1">
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="advance-tab-button advance-tab-button-1">
                                                                    <ul class="rbt-default-tab-button nav nav-tabs"
                                                                        id="courseSetting" role="tablist">
                                                                        <li class="nav-item" role="presentation">
                                                                            <a href="#" class="active" id="general-tab"
                                                                                data-bs-toggle="tab"
                                                                                data-bs-target="#general" role="tab"
                                                                        ...
                                                                        <li class="nav-item" role="presentation">
                                                                            <a href="#" id="content-tab"
                                                                                data-bs-toggle="tab"
                                                                                data-bs-target="#content" role="tab"
                                                                    ...
                                                                    <div class="tab-pane fade advance-tab-content-1 active show"
                                                                        ...
                                                                        <div class="course-field mb--20">
                                                                            <label for="field-4">Difficulty
                                                                                Level</label>
                                                                            <div
                                                                                class="rbt-modern-select bg-transparent height-45 mb--10">
                                                                        ...
                                                                        <div class="course-field mb--20">
                                                                            <label
                                                                                ...
                                                                                for="flexSwitchCheckDefault">Public
                                                                                Course</label>
                                                                        ...
                                                                        <div class="course-field mb--20">
                                                                            <label
                                                                                class="form-check-label d-inline-block"
                                                                                for="flexSwitchCheckDefault2">Q&A</label>
                                                                            <div class="form-check form-switch mb--10">
                                                                                <input class="form-check-input"
                                                                                    type="checkbox" role="switch"
                                                                        ...
                                                                        <div class="rbt-content-drip-content">
                                                                            <div class="course-field pb--20">
                                                                                <p class="rbt-checkbox-wrapper mb--5">
                                                                                    <input id="rbt-checkbox-1"
                                                                                        name="rbt-checkbox-1"
                                                                                        type="checkbox" value="yes">
                                                                                    <label
                                                                                        for="rbt-checkbox-1">Enable</label>
                                                                                </p>
                                        ...
                                        <div class="accordion-body card-body">
                                            <div class="accordion-item card mb--20">
                                                <h2 class="accordion-header card-header rbt-course" id="accOne1">
                                                    <button class="accordion-button collapsed" type="button"
                                                        data-bs-toggle="collapse" data-bs-target="#accCollapseOne1"
                                                        aria-expanded="false" aria-controls="accCollapseOne1">Lesson
                                                        One</button>
                                                ...
                                                <div id="accCollapseOne1" class="accordion-collapse collapse"
                                                    aria-labelledby="accOne1">
                                                    <div class="accordion-body card-body" id="dnd1">
                                                        <div
                                                            class="d-flex justify-content-between rbt-course-wrape mb-4">
                                                            <div class="col-10 inner d-flex align-items-center gap-2"><i
                                                                    class="feather-menu cursor-scroll"></i>
                                                                <h6 class="rbt-title mb-0">The Complete Histudy 2025:
                                                                    From Zero to Expert!</h6>
                                                            </div>
                                                            <div class="col-2 inner">
                                                                <ul
                                                                    class="rbt-list-style-1 rbt-course-list d-flex gap-2">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="gap-3 d-flex flex-wrap"><button
                                                                ...
                                                                <button
                                                                    class="rbt-btn btn-border hover-icon-reverse rbt-sm-btn-2"
                                                                    type="button" data-bs-toggle="modal"
                                                                    data-bs-target="#Assignment"><span
                                                                        class="icon-reverse-wrapper"><span
                                                            ...
                                                            <div class="mt-3 mt-md-0">
                                                                <button
                                                                    class="rbt-btn btn-border hover-icon-reverse rbt-sm-btn-2"><span
                                                                        class="icon-reverse-wrapper"><span
                                            ...
                                            <div class="accordion-item card mb--20">
                                                <h2 class="accordion-header card-header rbt-course" id="accOne2">
                                                    <button class="accordion-button collapsed" type="button"
                                                        data-bs-toggle="collapse" data-bs-target="#accCollapseOne2"
                                                        aria-expanded="false" aria-controls="accCollapseOne2">Lesson
                                                        two</button>
                                                    <span class="rbt-course-icon rbt-course-edit" data-bs-toggle="modal"
                                                        data-bs-target="#UpdateTopic"></span><span
                                                        class="rbt-course-icon rbt-course-del"></span>
                                                </h2> 
                                                <div id="accCollapseOne2" class="accordion-collapse collapse"
                                                    aria-labelledby="accOne2">
                                        ...
                                        <div
                                            ...
                                            <div class="col-lg-6">
                                                <div class="course-field mb--15">
                                                    ...
                                                    <div class="rbt-modern-select bg-transparent height-50 mb--10">
                                                        <select class="w-100" data-live-search="true" title="English"
                                                            multiple data-size="7" data-actions-box="true"
                                                            data-selected-text-format="count > 2" id="language">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="course-field mb--15">
                                                    ...
                                                    <textarea id="courseTag" rows="5"
                                                        placeholder="Add your course tag here."></textarea>
                                                    <small class="d-block mt_dec--5"><i class="feather-info"></i>
                                ...
                                <div class="accordion-item card">
                                    <h2 class="accordion-header card-header" id="accSeven">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#accCollapseEight"
                                            aria-expanded="false" aria-controls="accCollapseEight">
                                            Certificate Template
                                        </button>
                                    </h2>
                                    <div id="accCollapseEight" class="accordion-collapse collapse"
                                        aria-labelledby="accSeven" data-bs-parent="#tutionaccordionExamplea1">
                                        <div class="accordion-body card-body">

                                            <div class="advance-tab-button advance-tab-button-1">
                                                <ul class="rbt-default-tab-button nav nav-tabs" id="myTab"
                                                    role="tablist">
                                                    <li class="nav-item" role="presentation">
                                                        <a href="#" class="active" id="landscape-tab"
                                                            data-bs-toggle="tab" data-bs-target="#landscape" role="tab"
                                                            aria-controls="landscape" aria-selected="true">
                                                            <span>Landscape</span>
                                                        </a>
                                                    </li>
                                                    <li class="nav-item" role="presentation">
                                                        <a href="#" id="portrait-tab" data-bs-toggle="tab"
                                                            data-bs-target="#portrait" role="tab"
                                                            aria-controls="portrait" aria-selected="false">
                                                            <span>Portrait</span>
                                                        </a>
                                                    </li>
                                                </ul>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="tab-content">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="certificate-inner rbt-image-checkbox">
                                                                        <input type="radio" id="option2"
                                                                            name="radio-group" value="option2">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="certificate-inner rbt-image-checkbox">
                                                                        <input type="radio" id="option3"
                                                                            name="radio-group" value="option3">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="certificate-inner rbt-image-checkbox">
                                                                        <input type="radio" id="option4"
                                                                            name="radio-group" value="option4">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="certificate-inner rbt-image-checkbox">
                                                                        <input type="radio" id="option5"
                                                                            name="radio-group" value="option5">
                                                                        <label for="option5"><img
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="certificate-inner rbt-image-checkbox">
                                                                        <input type="radio" id="option6"
                                                                            name="radio-group" value="option6">
                                                                        <label for="option6"><img
                                                        ...
                                                        <div class="tab-pane fade advance-tab-content-1" id="portrait"
                                                            role="tabpanel" aria-labelledby="portrait-tab">
                                                            ...
                                                            <div class="row g-5 mt--10">
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="certificate-inner rbt-image-checkbox">
                                                                        <input type="radio" id="optionport1"
                                                                            name="radio-group" value="optionport1">
                                                                        <label for="optionport1"><img
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="certificate-inner rbt-image-checkbox">
                                                                        <input type="radio" id="optionport2"
                                                                            name="radio-group" value="optionport2">
                                                                        <label for="optionport2"><img
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="certificate-inner rbt-image-checkbox">
                                                                        <input type="radio" id="optionport3"
                                                                            name="radio-group" value="optionport3">
                                                                        <label for="optionport3"><img
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="certificate-inner rbt-image-checkbox">
                                                                        <input type="radio" id="optionport4"
                                                                            name="radio-group" value="optionport4">
                                                                        <label for="optionport4"><img
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="certificate-inner rbt-image-checkbox">
                                                                        <input type="radio" id="optionport5"
                                                                            name="radio-group" value="optionport5">
                                                                        <label for="optionport5"><img
                                                                ...
                                                                <div class="col-lg-4">
                                                                    <div class="certificate-inner rbt-image-checkbox">
                                                                        <input type="radio" id="optionport6"
                                                                            name="radio-group" value="optionport6">
                                                                        <label for="optionport6"><img
        ...
        <!-- Start Topic Area  -->
        <div class="rbt-default-modal modal fade" id="UpdateTopic" tabindex="-1" aria-labelledby="UpdateTopicLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        <div class="rbt-default-modal modal fade" id="Lesson" tabindex="-1" aria-labelledby="LessonLabel"
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header"><button type="button" class="rbt-round-btn" data-bs-dismiss="modal"
                            aria-label="Close"><i class="feather-x"></i></button></div>
                    <div class="modal-body">
                        <div class="inner rbt-default-form">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="course-field mb--20">
                                        <h6>Video Source</h6>
                                        <div class="rbt-modern-select bg-transparent height-45 w-100 mb--10"><select
                                                class="w-100">
                                    ...
                                    <div class="course-field mb--15"><label>Video playback time</label>
                                        <div class="row row--15">
                                            <div class="col-lg-4"><input type="number" placeholder="00"><small
                                                    class="d-block mt_dec--5"><i class="feather-info"></i> Hour.</small>
                                            </div>
                                            <div class="col-lg-4"><input type="number" placeholder="00"><small
                                                    class="d-block mt_dec--5"><i class="feather-info"></i>
                                                    Minute.</small></div>
                                            <div class="col-lg-4"><input type="number" placeholder="00"><small
                                                    class="d-block mt_dec--5"><i class="feather-info"></i>
                                                    Second.</small></div>
                                    ...
                                    <div class="course-field mb--20">
                                        ...
                                        <div class="rbt-modern-select bg-transparent height-45 w-100 mb--10"><button
                                                class="rbt-btn btn-md btn-border hover-icon-reverse"><span
                                                    class="icon-reverse-wrapper"><span class="btn-text">Upload
                                                        ...
                                                        class="btn-icon"><i
                                                            class="feather-paperclip"></i></span></span></button><input
                                                type="file" style="display: none;"></div>
                                    </div>
                                    <div class="course-field mb--20">
                                        <p class="rbt-checkbox-wrapper mb--5 d-flex"><input id="rbt-checkbox-11"
                                                name="rbt-checkbox-11" type="checkbox" value="yes"><label
                                                for="rbt-checkbox-11">Enable Course Preview</label></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="top-circle-shape"></div>
                    <div class="modal-footer pt--30 justify-content-between"><button type="button"
                            class="rbt-btn btn-border btn-md radius-round-10" data-bs-dismiss="modal">Cancel</button>
        ...
        <!-- Quiz Mddal -->
        <div class="rbt-default-modal modal fade" id="Quiz" tabindex="-1" aria-labelledby="QuizLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header"><button type="button" class="rbt-round-btn" data-bs-dismiss="modal"
                                    ...
                                    <div class="course-field quiz-modal mb--40">
                                        ...
                                        <div class="position-relative m-4">
                                            <div class="progress" role="progressbar" aria-label="Progress"
                                                aria-valuenow="33.3333" aria-valuemin="0" aria-valuemax="100">
                                                <div class="progress-bar" style="width: 33.3333%;"></div>
                                            </div>
                                            <button type="button"
                                                class="position-absolute top-0 start-0 translate-middle btn quiz-modal-btn quiz-modal__active">
                                                <i class="feather-check"></i>
                                            </button>
                                            <button type="button"
                                                class="position-absolute top-0 start-50 translate-middle btn quiz-modal-btn">2</button>
                                            <button type="button"
                                                class="position-absolute top-0 start-100 translate-middle btn quiz-modal-btn btn-secondary">3</button>
                                        </div>
                                    </div>
                                    <form class="tabs-1" id="quiz-form">
                                        <div id="question-1" class="question">
                                            <div class="course-field mb--20"><label for="modal-field-1">Quiz
                                                    Title</label><input id="modal-field-1" type="text"
                                                    placeholder="Type your quiz title here"></div>
                                            ...
                                            <div class="content">
                                                <div class="course-field mb--20">
                                                    <div class="d-flex justify-content-between rbt-course-wrape mb-4"
                                                        ...
                                                        <div class="inner">
                                                            <ul
                                                                class="rbt-list-style-1 rbt-course-list d-flex gap-3 align-items-center">
                                                ...
                                                <div class="course-field">
                                                    <button
                                                        class="rbt-btn btn-active hover-icon-reverse rbt-sm-btn-2 btn-1"
                                                        type="button" id="next-btn-2">
                                        ...
                                        <div id="question-3" class="question">
                                            <div class="content">
                                                <div class="course-field mb--20"><label for="modal-field-3">Write your
                                                        question here</label><input id="modal-field-3" type="text"
                                                ...
                                                <div class="course-field mb--20">
                                                    ...
                                                    <div class="d-flex align-items-center gap-5 mt--20">
                                                        <div class="form-check form-switch"><input
                                                                ...
                                                                id="switchCheckAnswer"><label class="form-check-label"
                                                                for="switchCheckAnswer">Answer
                                                                Required</label></div>
                                                        <div class="form-check form-switch"><input
                                                                class="form-check-input" type="checkbox" role="switch"
                                                                id="switchCheckRandomize"><label
                                                                class="form-check-label"
                                                                for="switchCheckRandomize">Randomize</label></div>
                                                    </div>
                                                </div>
                                                <div class="course-field mb--20"><label for="modal-field-3">Point(s) for
                                                        this answer</label>
                                                    <div class="d-flex align-items-center gap-5 mb--20">
                                                        <div class="content"><input class="mb-0" id="modal-field-3"
                                                                type="text" placeholder="set the mark ex. 10">
                                                        </div>
                                                        <div class="form-check form-switch"><input
                                                                class="form-check-input" type="checkbox" role="switch"
                                                                id="switchCheckAnswerTwo"><label
                                                                class="form-check-label"
                                                                for="switchCheckAnswerTwo">Answer
                                                                Required</label></div>
                                                    </div>
                                                    ...
                                                    <div class="course-field rbt-lesson-rightsidebar d-block mt--20">
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="rbt-form-check"><input
                                                                        class="form-check-input" type="radio"
                                                                        name="rbt-radio" id="rbt-single-1"><label
                                                                        class="form-check-label"
                                                                        for="rbt-single-1">True</label></div>
                                                            </div>
                                                            <div class="col-lg-6">
                                                                <div class="rbt-form-check"><input
                                                                        class="form-check-input" type="radio"
                                                                        name="rbt-radio" id="rbt-single-2"><label
                                                                        class="form-check-label"
                                                                        for="rbt-single-2">False</label></div>
                                                            </div>
                                                        </div>
                                                    </div>

                                                    <div class="course-field mt--20">
                                                        <label for="modal-field-3">Answer title</label><input
                                                            id="modal-field-3" type="text" placeholder="title">
                                                        <div class="rbt-create-course-thumbnail upload-area mt--20">
                                                            ...
                                                            <div class="d-flex gap-4">
                                                                <div class="rbt-form-check"><input
                                                                        class="form-check-input" type="radio"
                                                                        name="rbt-radio" id="rbt-radio1"><label
                                                                        class="form-check-label h-auto"
                                                                        for="rbt-radio1">Only Text</label></div>
                                                                <div class="rbt-form-check"><input
                                                                        class="form-check-input" type="radio"
                                                                        name="rbt-radio" id="rbt-radio2"><label
                                                                        class="form-check-label h-auto"
                                                                        for="rbt-radio2">Image Only</label></div>
                                                                <div class="rbt-form-check"><input
                                                                        class="form-check-input" type="radio"
                                                                        name="rbt-radio" id="rbt-radio3"><label
                                                                        class="form-check-label h-auto"
                                                                        for="rbt-radio3">Text &amp; Image
                                                                        both</label></div>
                                                            </div><button class="rbt-btn rbt-sm-btn-2 mt--20"
                                                                type="button">Update Answer</button>
                                                        </div>
                                                    </div>
                                            ...
                                            <form class="tabs-3">
                                                <div class="course-field mb--20"><label for="modal-field-3">Time
                                                    ...
                                                    <div class="d-flex flex-wrap align-items-center gap-5">
                                                        ...
                                                        <div class="form-check form-switch"><input
                                                                class="form-check-input" type="checkbox" role="switch"
                                                                id="switchCheckAnswerTwo2"><label
                                                                class="form-check-label"
                                                                for="switchCheckAnswerTwo2">Hide quiz
                                                ...
                                                <div class="course-field"><label for="modal-field-3">Quiz Feedback
                                                    ...
                                                    <div class="d-flex flex-column gap-4 mt--10">
                                                        <div
                                                            class="rbt-form-check col-12 rbt-border-2 rounded-2 ps-4 py-3">
                                                            <input class="form-check-input ps-5" type="radio"
                                                                name="rbt-radio" id="rbt-radio1"><label
                                                                class="form-check-label h-auto" for="rbt-radio1">
                                                        ...
                                                        <div
                                                            ...
                                                            <input class="form-check-input ps-5" type="radio"
                                                                name="rbt-radio" id="rbt-radio2"><label
                                                                class="form-check-label h-auto" for="rbt-radio2">
                                                        ...
                                                        <div
                                                            ...
                                                            <input class="form-check-input ps-5" type="radio"
                                                                name="rbt-radio" id="rbt-radio3"><label
                                                                class="form-check-label h-auto" for="rbt-radio3">
                                                ...
                                                <div class="course-field mt--20">
                                                    <div class="col-xl-8"><label for="modal-field-4">Passing Grade
                                                            (%)</label><input class="mb-0" id="modal-field-4"
                                                            type="number" value="50"><small><i class="feather-info"></i>
                                                            Time limit for this quiz. 0 means no time
                                                            limit.</small></div>
                                                </div>
                                                <div class="course-field mt--20">
                                                    <div class="col-xl-8"><label for="modal-field-5">Max Question
                                                            Allowed to Answer</label><input class="mb-0"
                                                            id="modal-field-5" type="number" value="10"><small><i
                                                ...
                                                <div
                                                    class="course-field rbt-accordion-style rbt-accordion-01 rbt-accordion-06 accordion mt--30">
                                                    <div class="accordion-item card">
                                                        <h2 class="accordion-header card-header" id="accThree3"><button
                                                                class="accordion-button collapsed" type="button"
                                                                data-bs-toggle="collapse"
                                                                data-bs-target="#accCollapseThree3"
                                                                aria-expanded="false"
                                                                aria-controls="accCollapseThree3"><i
                                                                    class="feather-settings me-3"></i>Advance
                                                                Settings</button>
                                                        </h2>
                                                        <div id="accCollapseThree3" class="accordion-collapse collapse"
                                                            aria-labelledby="accThree3">
                                                            <div class="accordion-body card-body">
                                                                <div class="form-check form-switch mb--5"><input
                                                                        class="form-check-input" type="checkbox"
                                                                        role="switch" id="autoStart"><label
                                                                        class="form-check-label" for="autoStart">Quiz
                                                                        Auto
                                                                ...
                                                                <div class="course-field d-sm-flex gap-4 mt--20">
                                                                    <div class="col-sm-6 col-xl-3 mb-4 mb-sm-0"><label
                                                                            class="form-check-label"
                                                                            for="option-1">Question
                                                                            Layout</label>
                                                                        <div
                                                                            class="rbt-modern-select bg-transparent height-45 w-100 mb--10">
                                                                    ...
                                                                    <div class="col-sm-6 col-xl-4"><label
                                                                            class="form-check-label"
                                                                            for="option-1">Questions
                                                                            Order</label>
                                                                        <div
                                                                            class="rbt-modern-select bg-transparent height-45 w-100 mb--10">
                                                                            <select class="w-100 rbt-select-dark">
                                                                                <option
                                                                                    value="Set question layout view">Set
                                                                ...
                                                                <div class="course-field mt--20">
                                                                    <div class="form-check form-switch mb--5"><input
                                                                            class="form-check-input" type="checkbox"
                                                                            role="switch" id="hideNumber"><label
                                                                            class="form-check-label"
                                                                            for="hideNumber">Hide
                                                                ...
                                                                <div
                                                                    class="course-field d-lg-flex flex-wrap justify-content-between gap-5 mt--20">
                                                                    <div class="col-lg-7 mb-4 mb-lg-0"><label
                                                                            for="modal-field-sort-answer">Short answer
                                                                            characters
                                                                            limit</label><input class="mb-0"
                                                                            id="modal-field-sort-answer" type="number"
                                                                            value="200"><small><i
                                                                    ...
                                                                    <div class="col-lg-7"><label
                                                                            for="modal-field-3">Open-Ended/Essay
                                                                            questions answer character
                                                                            limit</label><input class="mb-0"
                                                                            id="modal-field-7" type="number"
                                                                            value="500"><small><i
                    ...
                    <div class="modal-footer pt--30 justify-content-between">
                        <button type="button" class="rbt-btn btn-border btn-md radius-round-10"
                            data-bs-dismiss="modal">Cancel</button>
                        <div class="content">
                            <button type="button" class="rbt-btn btn-border btn-md radius-round-10 mr--10"
                                id="prev-btn">Back</button>
                            <button type="button" class="rbt-btn btn-md radius-round-10 d-inline-block"
                                id="next-btn-2">Save &
                                Next</button>
                        </div>
                    </div>
        ...
        <!-- Assignment Modal -->
        <div class="rbt-default-modal modal fade" id="Assignment" tabindex="-1" aria-labelledby="AssignmentLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header"><button type="button" class="rbt-round-btn" data-bs-dismiss="modal"
                                ...
                                <div class="col-lg-12">
                                    <form action="#">
                                        ...
                                        <div class="course-field mb--15"><label>Time Limit</label>
                                            <div class="row row--15">
                                                <div class="col-sm-6 col-lg-4"><input class="shadow-none" type="number"
                                                        placeholder="00"></div>
                                        ...
                                        <div class="course-field mb--15"><label>Total Points</label>
                                            <div class="row row--15">
                                                <div class="col-lg-4"><input class="shadow-none" type="number"
                                                        placeholder="0"><small><i class="feather-info pr--5"></i>Maximum
                                                        points a
                    ...
                    <div class="modal-footer pt--30 justify-content-between"><button type="button"
                            ...
                            data-bs-dismiss="modal">Cancel</button><button type="button" class="rbt-btn btn-md">Save
                            &amp; Next</button></div>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12">
                <div class="inner text-center">
                    ...
                    <div class="text mt--20">
                        <p>© 2025 <a target="_blank" href="https://www.pixcelsthemes.com/portfolio">Pixcle Themes</a>. All
                            Rights Reserved.</p>
                    </div>
                </div>
            </div>
