...
<head>
    ...
    <title>Student Enrolled Courses - Best Data Analytics Courses in Hyderabad</title>
            ...
            <div class="rbt-default-sidebar-wrapper">
                ...
                <nav class="mainmenu-nav">
                    <ul class="dashboard-mainmenu rbt-default-sidebar-list">
                        <li><a href="student-dashboard.php"><i class="feather-home"></i><span>Dashboard</span></a></li>
                        <li><a href="student-profile.php"><i class="feather-user"></i><span>My Profile</span></a></li>
                        <li><a href="student-enrolled-courses.php"><i class="feather-book-open"></i><span>Enrolled Courses</span></a></li>
                        <li><a href="student-wishlist.php"><i class="feather-bookmark"></i><span>Wishlist</span></a></li>
                        <li><a href="student-reviews.php"><i class="feather-star"></i><span>Reviews</span></a></li>
                        <li><a href="student-my-quiz-attempts.php"><i class="feather-help-circle"></i><span>My Quiz Attempts</span></a></li>
                        <li><a href="student-order-history.php"><i class="feather-shopping-bag"></i><span>Order History</span></a></li>
                    </ul>
                </nav>
                ...
                <nav class="mainmenu-nav">
                    <ul class="dashboard-mainmenu rbt-default-sidebar-list">
                        <li><a href="student-settings.php"><i class="feather-settings"></i><span>Settings</span></a></li>
