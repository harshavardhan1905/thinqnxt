...
<head>
    ...
    <title>Instructor Settings - Best Data Analytics Courses in Hyderabad</title>
                                                ...
                                                <form action="#" class="rbt-profile-row rbt-default-form row row--15">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="rbt-form-group">
                                                            ...
                                                            <textarea id="bio" cols="20" rows="5" >I'm the Front-End Developer for #Pixcels IT in India, OR. I have serious passion for UI effects, animations and creating intuitive, dynamic user experiences.</textarea>
                                                        </div>
                                                    </div>
