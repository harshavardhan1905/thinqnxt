...
<head>
    ...
    <title>Gym Coaching - Best Data Analytics Courses in Hyderabad</title>
            ...
            <div class="row g-5">
                    ...
                    <div class="rbt-card variation-03 rbt-hover program-image-large">
                        <div class="rbt-card-img">
                            <a class="thumbnail-link" href="course-details.php">
                                <img src="assets/images/course/gym-program-01.jpg" alt="Card image">
                        ...
                        <div class="rbt-card-body">
                            <h5 class="rbt-card-title"><a href="course-details.php">Fitness Consultation</a>
                            </h5>
                            <div class="rbt-card-bottom">
                                <a class="transparent-button"
                                    href="course-details.php"><i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg"><g stroke="#27374D" fill="none" fill-rule="evenodd"><path d="M10.614 0l5.629 5.629-5.63 5.629"/><path stroke-linecap="square" d="M.663 5.572h14.594"/></g></svg></i></a>
                            </div>
                        </div>
                        <div class="card-information">
                            <div class="card-flag">
                                <img src="assets/images/icons/runner.png" alt="united-kingdom"> 
                            </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up"
                    ...
                    <div class="rbt-card variation-03 rbt-hover program-image-large">
                        <div class="rbt-card-img">
                            <a class="thumbnail-link" href="course-details.php">
                                <img src="assets/images/course/gym-program-02.jpg" alt="Card image">
                                <span class="rbt-btn btn-white icon-hover btn-md">
                                    <span class="btn-text">Read More</span>
                                    <span class="btn-icon"><i class="feather-arrow-right"></i></span>
                                </span>
                        ...
                        <div class="rbt-card-body">
                            <h5 class="rbt-card-title"><a href="course-details.php">Powerful and Strong</a>
                            </h5>
                            <div class="rbt-card-bottom">
                                <a class="transparent-button"
                                    href="course-details.php"><i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg"><g stroke="#27374D" fill="none" fill-rule="evenodd"><path d="M10.614 0l5.629 5.629-5.63 5.629"/><path stroke-linecap="square" d="M.663 5.572h14.594"/></g></svg></i></a>
                        ...
                        <div class="card-information">
                            <div class="card-flag">
                                <img src="assets/images/icons/power.png" alt="Education Images"> 
                            </div>
                            <div class="card-count">21 programs</div>
                        </div>
                    </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up"
                    ...
                    <div class="rbt-card variation-03 rbt-hover program-image-large">
                        <div class="rbt-card-img">
                            <a class="thumbnail-link" href="course-details.php">
                                <img src="assets/images/course/gym-program-03.jpg" alt="Card image">
                                <span class="rbt-btn btn-white icon-hover btn-md">
                                    <span class="btn-text">Read More</span>
                                    <span class="btn-icon"><i class="feather-arrow-right"></i></span>
                                </span>
                        ...
                        <div class="rbt-card-body">
                            <h5 class="rbt-card-title"><a href="course-details.php">Personal Training</a>
                            </h5>
                            <div class="rbt-card-bottom">
                                <a class="transparent-button"
                                    href="course-details.php"><i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg"><g stroke="#27374D" fill="none" fill-rule="evenodd"><path d="M10.614 0l5.629 5.629-5.63 5.629"/><path stroke-linecap="square" d="M.663 5.572h14.594"/></g></svg></i></a>
                        ...
                        <div class="card-information">
                            <div class="card-flag">
                                <img src="assets/images/icons/runner.png" alt="Education Images"> 
                            </div>
                            <div class="card-count">21 programs</div>
                        </div>
                    </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up"
                    ...
                    <div class="rbt-card variation-03 rbt-hover program-image-large">
                        <div class="rbt-card-img">
                            <a class="thumbnail-link" href="course-details.php">
                                <img src="assets/images/course/gym-program-04.jpg" alt="Card image">
                                <span class="rbt-btn btn-white icon-hover btn-md">
                                    <span class="btn-text">Read More</span>
                                    <span class="btn-icon"><i class="feather-arrow-right"></i></span>
                                </span>
                        ...
                        <div class="rbt-card-body">
                            <h5 class="rbt-card-title"><a href="course-details.php">Fit And Sports</a>
                            </h5>
                            <div class="rbt-card-bottom">
                                <a class="transparent-button"
                                    href="course-details.php"><i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg"><g stroke="#27374D" fill="none" fill-rule="evenodd"><path d="M10.614 0l5.629 5.629-5.63 5.629"/><path stroke-linecap="square" d="M.663 5.572h14.594"/></g></svg></i></a>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up"
                    ...
                    <div class="rbt-card variation-03 rbt-hover program-image-large">
                        <div class="rbt-card-img">
                            <a class="thumbnail-link" href="course-details.php">
                                <img src="assets/images/course/gym-program-05.jpg" alt="Card image">
                                <span class="rbt-btn btn-white icon-hover btn-md">
                                    <span class="btn-text">Read More</span>
                                    <span class="btn-icon"><i class="feather-arrow-right"></i></span>
                                </span>
                        ...
                        <div class="rbt-card-body">
                            <h5 class="rbt-card-title"><a href="course-details.php">Keep Your Body</a>
                            </h5>
                            <div class="rbt-card-bottom">
                                <a class="transparent-button"
                                    href="course-details.php"><i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg"><g stroke="#27374D" fill="none" fill-rule="evenodd"><path d="M10.614 0l5.629 5.629-5.63 5.629"/><path stroke-linecap="square" d="M.663 5.572h14.594"/></g></svg></i></a>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up"
                    ...
                    <div class="rbt-card variation-03 rbt-hover program-image-large">
                        <div class="rbt-card-img">
                            <a class="thumbnail-link" href="course-details.php">
                                <img src="assets/images/course/gym-program-06.jpg" alt="Card image">
                                <span class="rbt-btn btn-white icon-hover btn-md">
                                    <span class="btn-text">Read More</span>
                                    <span class="btn-icon"><i class="feather-arrow-right"></i></span>
                                </span>
                        ...
                        <div class="rbt-card-body">
                            <h5 class="rbt-card-title"><a href="course-details.php">Strongest Self</a>
                            </h5>
                            <div class="rbt-card-bottom">
                                <a class="transparent-button"
                                    href="course-details.php"><i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg"><g stroke="#27374D" fill="none" fill-rule="evenodd"><path d="M10.614 0l5.629 5.629-5.63 5.629"/><path stroke-linecap="square" d="M.663 5.572h14.594"/></g></svg></i></a>
        ...
        <div class="inner">
            ...
            <div class="content">
                ...
                <div class="read-more-btn">
                    <a href="course-filter-one-toggle.php"><i class="feather-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="mesonry-list grid-metro3">
                        ...
                        <div class="maso-item cat--1">
                            <div class="rbt-card variation-01 rbt-hover">
                                <div class="rbt-card-img">
                                    <a href="course-details.php">
                                        <img src="assets/images/course/gym-01.jpg" alt="Card image">
                                ...
                                <div class="rbt-card-body">
                                    ...
                                    <h4 class="rbt-card-title"><a href="course-details.php">Seven Reasons You Fall In Love With Gym.</a>
                                    </h4>
                                    <div class="rbt-review">
                                        <div class="rating">
                                            <i class="fas fa-star"></i>
                        ...
                        <div class="maso-item cat--2">
                            <div class="rbt-card variation-01 rbt-hover">
                                <div class="rbt-card-img">
                                    <a href="course-details.php">
                                        <img src="assets/images/course/gym-02.jpg" alt="Card image">
                                        <div class="rbt-badge-3 bg-white">
                                            <span>-40%</span>
                                            <span>Off</span>
                                        </div>
                                ...
                                <div class="rbt-card-body">
                                    ...
                                    <h4 class="rbt-card-title"><a href="course-details.php">Taboos About Gym You Should Share On Twitter.</a>
                                    </h4>
                                    <div class="rbt-review">
                                        <div class="rating">
                                            <i class="fas fa-star"></i>
                        ...
                        <div class="maso-item cat--3">
                            <div class="rbt-card variation-01 rbt-hover">
                                <div class="rbt-card-img">
                                    <a href="course-details.php">
                                        <img src="assets/images/course/gym-03.jpg" alt="Card image">
                                        <div class="rbt-badge-3 bg-white">
                                            <span>-40%</span>
                                            <span>Off</span>
                                        </div>
                                ...
                                <div class="rbt-card-body">
                                    ...
                                    <h4 class="rbt-card-title"><a href="course-details.php">Ten Moments Basically Gym Experience.</a>
                                    </h4>
                                    <div class="rbt-review">
                                        <div class="rating">
                                            <i class="fas fa-star"></i>
                        ...
                        <div class="maso-item cat--4">
                            <div class="rbt-card variation-01 rbt-hover">
                                <div class="rbt-card-img">
                                    <a href="course-details.php">
                                        <img src="assets/images/course/gym-04.jpg" alt="Card image">
                                        <div class="rbt-badge-3 bg-white">
                                            <span>-40%</span>
                                            <span>Off</span>
                                        </div>
                                ...
                                <div class="rbt-card-body">
                                    ...
                                    <h4 class="rbt-card-title"><a href="course-details.php">Common Miscon ceptions About Gym.</a>
                                    </h4>
                                    <div class="rbt-review">
                                        <div class="rating">
                                            <i class="fas fa-star"></i>
                        ...
                        <div class="maso-item cat--1 cat--3">
                            <div class="rbt-card variation-01 rbt-hover">
                                <div class="rbt-card-img">
                                    <a href="course-details.php">
                                        <img src="assets/images/course/gym-05.jpg" alt="Card image">
                                        <div class="rbt-badge-3 bg-white">
                                            <span>-40%</span>
                                            <span>Off</span>
                                        </div>
                                ...
                                <div class="rbt-card-body">
                                    ...
                                    <h4 class="rbt-card-title"><a href="course-details.php">Eliminate Fears And Doubts About Gym.</a>
                                    </h4>
                                    <div class="rbt-review">
                                        <div class="rating">
                                            <i class="fas fa-star"></i>
                        ...
                        <div class="maso-item cat--2 cat--4">
                            <div class="rbt-card variation-01 rbt-hover">
                                <div class="rbt-card-img">
                                    <a href="course-details.php">
                                        <img src="assets/images/course/gym-06.jpg" alt="Card image">
                                        <div class="rbt-badge-3 bg-white">
                                            <span>-40%</span>
                                            <span>Off</span>
                                        </div>
                                ...
                                <div class="rbt-card-body">
                                    ...
                                    <h4 class="rbt-card-title"><a href="course-details.php">Benefits Gym Change Your Perspective.</a>
                                    </h4>
                                    <div class="rbt-review">
                                        <div class="rating">
                                            <i class="fas fa-star"></i>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mt--30 col-12">
                            <div class="radial-progress-single">
                                <div class="radial-progress" data-percent="80" data-bar-color="#2f57ef"
                                    data-track-color="#F6F6F6">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mt--30 col-12">
                            <div class="radial-progress-single">
                                <div class="radial-progress" data-percent="60" data-bar-color="#2f57ef"
                                    data-track-color="#F6F6F6">
                                    <div class="circle-text">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mt--30 col-12">
                            <div class="radial-progress-single">
                                <div class="radial-progress" data-percent="70" data-bar-color="#2f57ef"
                                    data-track-color="#F6F6F6">
                                    <div class="circle-text">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6 mt--30 col-12">
                            <div class="radial-progress-single">
                                <div class="radial-progress" data-percent="95" data-bar-color="#2f57ef"
                                    data-track-color="#F6F6F6">
                                    <div class="circle-text">
            ...
            <div class="row g-5">
                    ...
                    <div class="rbt-card card-list-2 event-list-card variation-01 rbt-hover">
                        <div class="rbt-card-img">
                            <a href="event-details.php">
                                <img src="assets/images/event/gym-01.jpg" alt="Card image">
                            </a>
                        </div>
                        <div class="rbt-card-body">
                            <ul class="rbt-meta">
                            ...
                            <h4 class="rbt-card-title"><a href="event-details.php">This Is Why Gym Is So Famous!</a></h4>
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="rbt-card card-list-2 event-list-card variation-01 rbt-hover">
                        <div class="rbt-card-img">
                            <a href="event-details.php">
                                <img src="assets/images/event/gym-02.jpg" alt="Card image">
                            </a>
                        </div>
                        <div class="rbt-card-body">
                            <ul class="rbt-meta">
                            ...
                            <h4 class="rbt-card-title"><a href="event-details.php">Ten Useful Tips From Experts In Gym.</a></h4>
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="rbt-card card-list-2 event-list-card variation-01 rbt-hover">
                        <div class="rbt-card-img">
                            <a href="event-details.php">
                                <img src="assets/images/event/gym-03.jpg" alt="Card image">
                            </a>
                        </div>
                        <div class="rbt-card-body">
                            <ul class="rbt-meta">
                            ...
                            <h4 class="rbt-card-title"><a href="event-details.php">Why Is Gym Considered Underrated?</a>
                            </h4>
                ...
                <div class="col-lg-6 col-md-12 col-12">
                    <div class="rbt-card card-list-2 event-list-card variation-01 rbt-hover">
                        <div class="rbt-card-img">
                            <a href="event-details.php">
                                <img src="assets/images/event/gym-04.jpg" alt="Card image">
                            </a>
                        </div>
                        <div class="rbt-card-body">
                            <ul class="rbt-meta">
                            ...
                            <h4 class="rbt-card-title"><a href="event-details.php">Ten Quick Tips For Gym.</a></h4>
                    ...
                    <div class="row g-0 align-items-center">
                        <div class="col-lg-12 col-xl-6 col-12">
                            <div class="thumbnail image-left-content">
                                <img src="assets/images/split/split-02.jpg" alt="split Images">
                            </div>
                        </div>
                        <div class="col-lg-12 col-xl-6 col-12">
                            <div class="split-inner text-start">
                                <div class="shape">
                                    <img src="assets/images/shape/workout.png" alt="Shape Images">
                                </div>
       ...
       <div class="rbt-callto-action rbt-cta-default style-4 variation-2 bg-gradient-6 mt--75">
            <div class="container">
                <div class="row align-items-center content-wrapper row--30 mt_dec--30 position-relative">
                    ...
                    <div class="thumbnail">
                        <img class="w-100" src="assets/images/shape/cta-2.png" alt="Shape Images">
                    </div>
                </div>
            </div>
        </div>
