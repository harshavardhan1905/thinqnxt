...
<head>
    ...
    <title>Instructor Portfolio - Best Data Analytics Courses in Hyderabad</title>
        ...
        <div class="rbt-callto-action rbt-cta-default style-4 variation-2 bg-gradient-6 mt--75">
            <div class="container">
                <div class="row align-items-center content-wrapper row--30 mt_dec--30 position-relative">
                    ...
                    <div class="thumbnail">
                        <img class="w-100" src="assets/images/shape/cta-4.png" alt="Shape Images">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="rbt-card variation-01 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            ...
                            <h4 class="rbt-card-title"><a href="course-details.php">React Js</a>
                            </h4>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="rbt-card variation-01 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            ...
                            <h4 class="rbt-card-title"><a href="course-details.php">Javascript</a>
                            </h4>
                            <p class="rbt-card-text">It is a long established fact that a reader will be distracted by
                                the readable content of a page when looking at its layout.</p>
                            <div class="rbt-review">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="rbt-card variation-01 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            ...
                            <h4 class="rbt-card-title"><a href="course-details.php">Angular Js</a>
                            </h4>
                            <p class="rbt-card-text">It is a long established fact that a reader will be distracted by
                                the readable content of a page when looking at its layout.</p>
                            <div class="rbt-review">
    ...
    <div class="rbt-contact-me bg-color-white rbt-section-gapBottom">
        <div class="container">
            ...
            <div class="row g-5">
                <div class="col-lg-6">
                    <div class="thumbnail">
                        <img class="w-100 radius-10" src="assets/images/about/contact-2.jpg" alt="Contact Images">
                    </div>
                </div>
                <div class="col-lg-6">
