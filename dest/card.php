...
<head>
    ...
    <title>Card Style - Best Data Analytics Courses in Hyderabad</title>
            ...
            <div class="col-lg-12">
                <div class="breadcrumb-inner text-center">
                    ...
                    <ul class="page-list">
                        ...
                        <li class="rbt-breadcrumb-item active">Card</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="rbt-rbt-card-area rbt-section-gap bg-color-white">
        <div class="container">
            <div class="row row--15 align-items-center mb--30">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2 class="title">Card Style One</h2>
                    </div>
                </div>
            </div>
            <!-- Start Card Area -->
    ...
    <div class="rbt-rbt-card-area rbt-section-gap bg-color-extra2">
        <div class="container">
            <div class="row row--15 align-items-center mb--30">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2 class="title">Card Style Two</h2>
                    </div>
                </div>
            </div>
            <!-- Start Card Area -->
            <div class="row row--15">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-12 mt--30" data-sal-delay="150" data-sal="slide-up"
                    ...
                    <div class="rbt-card height-330 variation-02 rbt-hover">
                        <div class="rbt-card-img">
                            <a href="course-details.php">
                                <img src="assets/images/blog/blog-card-01.jpg" alt="Card image">
                        ...
                        <div class="rbt-card-body">
                            <h4 class="rbt-card-title"><a href="course-details.php">Chemistry</a>
                            </h4>
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-12 mt--30" data-sal-delay="150" data-sal="slide-up"
                    ...
                    <div class="rbt-card card-list variation-02 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            <h5 class="rbt-card-title"><a href="course-details.php">Competitive Strategy law of
                                    education.</a></h5>
                            <div class="rbt-card-bottom">
                                <a class="transparent-button" href="course-details.php">Learn
                                    More<i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg"><g stroke="#27374D" fill="none" fill-rule="evenodd"><path d="M10.614 0l5.629 5.629-5.63 5.629"/><path stroke-linecap="square" d="M.663 5.572h14.594"/></g></svg></i></a>
                    ...
                    <div class="rbt-card card-list variation-02 rbt-hover mt--30">
                        ...
                        <div class="rbt-card-body">
                            <h5 class="rbt-card-title"><a href="course-details.php">Difficult Things About
                                    Education.</a></h5>
                            <div class="rbt-card-bottom">
                                <a class="transparent-button" href="course-details.php">Learn
                                    More<i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg"><g stroke="#27374D" fill="none" fill-rule="evenodd"><path d="M10.614 0l5.629 5.629-5.63 5.629"/><path stroke-linecap="square" d="M.663 5.572h14.594"/></g></svg></i></a>
                    ...
                    <div class="rbt-card card-list variation-02 rbt-hover mt--30">
                        ...
                        <div class="rbt-card-body">
                            <h5 class="rbt-card-title"><a href="course-details.php">Education Is So Famous, But
                                    Know.</a></h5>
                            <div class="rbt-card-bottom">
                                <a class="transparent-button" href="course-details.php">Learn
                                    More<i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg"><g stroke="#27374D" fill="none" fill-rule="evenodd"><path d="M10.614 0l5.629 5.629-5.63 5.629"/><path stroke-linecap="square" d="M.663 5.572h14.594"/></g></svg></i></a>
    ...
    <div class="rbt-rbt-card-area rbt-section-gap bg-color-white">
        <div class="container">
            <div class="row row--15 align-items-center mb--30">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2 class="title">Card Style Three</h2>
                    </div>
                </div>
            </div>
            <!-- Start Card Area -->
    ...
    <div class="rbt-rbt-card-area rbt-section-gap bg-color-extra2">
        <div class="container">
            <div class="row row--15 align-items-center mb--30">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2 class="title">Card Style Four</h2>
                    </div>
                </div>
            </div>
            <!-- Start Card Area -->
                ...
                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mt--30" data-sal-delay="150" data-sal="slide-up"
                    ...
                    <div class="rbt-card variation-01 rbt-hover card-list-2">
                        ...
                        <div class="rbt-card-body">
                            ...
                            <h4 class="rbt-card-title"><a href="course-details.php">Web Designs About Education.</a>
                            </h4>
                            <span class="lesson-number">12 lessons <span class="lesson-time">(4 hours total)</span></span>
                            <p class="rbt-card-text">It is a long established fact that a reader will be distracted.</p>
                            <div class="rbt-card-bottom">
    ...
    <div class="rbt-rbt-card-area rbt-section-gap bg-color-white">
        <div class="container">
            <div class="row row--15 align-items-center mb--30">
                <div class="col-lg-12">
                    <div class="section-title">
                        <h2 class="title">Card Style Five</h2>
                    </div>
                </div>
            </div>
            <!-- Start Card Area -->
            <div class="row row--15">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 mt--30" data-sal-delay="150" data-sal="slide-up"
                    ...
                    <div class="rbt-card variation-03 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            <h5 class="rbt-card-title"><a href="course-details.php">Web Design About Education.</a>
                            </h5>
                            <div class="rbt-card-bottom">
                                <a class="transparent-button" href="course-details.php"><i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg"><g stroke="#27374D" fill="none" fill-rule="evenodd"><path d="M10.614 0l5.629 5.629-5.63 5.629"/><path stroke-linecap="square" d="M.663 5.572h14.594"/></g></svg></i></a>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 mt--30" data-sal-delay="150" data-sal="slide-up"
                    ...
                    <div class="rbt-card variation-03 rbt-hover">
                        ...
                        <div class="rbt-card-body">
                            <h5 class="rbt-card-title"><a href="course-details.php">English Class About Education.</a>
                            </h5>
                            <div class="rbt-card-bottom">
                                <a class="transparent-button" href="course-details.php"><i><svg width="17" height="12" xmlns="http://www.w3.org/2000/svg"><g stroke="#27374D" fill="none" fill-rule="evenodd"><path d="M10.614 0l5.629 5.629-5.63 5.629"/><path stroke-linecap="square" d="M.663 5.572h14.594"/></g></svg></i></a>
                            </div>
