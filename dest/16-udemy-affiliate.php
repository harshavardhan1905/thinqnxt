...
<head>
    ...
    <title>Udemy Affilite - Best Data Analytics Courses in Hyderabad</title>
...
<a class="close_side_menu" href="javascript:void(0);"></a>
    ...
    <!-- Start Banner Area  -->
    <div class="rbt-banner-area rbt-banner-11 bg-color-darker ptb--100">
        <div class="wrapper">
            <div class="container">
                <div class="swiper udemy-affilite-activation rbt-arrow-between">
                    <div class="swiper-wrapper">

                        <!-- Start Single Slider  -->
                        <div class="swiper-slide">
                            <div class="row gy-5 row--30 align-items-center">
                                <div class="col-lg-6">
                                    <div class="course-thumbnail">
                                        <a href="course-details.php">
                                            <img class="radius-6" src="assets/images/course/course-online-02.jpg"
                                                alt="Course Images">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="content">
                                        <div class="inner text-start">
                                            <div class="section-title">
                                                <span class="subtitle bg-secondary-opacity">Enjoy Learning!</span>
                                            </div>

                                            <div class="rbt-course-meta-wrapper d-flex align-items-center">
                                                <div class="rbt-author-meta">
                                                    ...
                                                    <div class="rbt-author-info">
                                                        By <a href="profile.php">Angela</a> In <a
                                                            href="#">Development</a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="feature-sin rating">
                                                    ...
                                                    <a href="#"><i class="fa fa-star"></i></a>
                                                    <a href="#"><i class="fa fa-star"></i></a>
                                                    <a class="rbt-title-style-2" href="#">(4.8)</a>
                                                </div>
                                            </div>


                                            <h2 class="banner-title">Learn English in <span class="theme-gradient">40
                                                    weeks</span> with spoken.</h2>

                                            <p class="description has-medium-font-size mt--20">Dive in and learn
                                                React.js from
                                                scratch! Learn Reactjs, Hooks, Redux, React Routing, Animations, Next.js
                                                and way
                                                more!
                                            </p>
                        ...
                        <div class="swiper-slide">
                            <div class="row gy-5 row--30 align-items-center">
                                <div class="col-lg-6">
                                    <div class="course-thumbnail">
                                        <a href="course-details.php">
                                            <img class="radius-6" src="assets/images/course/course-online-04.jpg"
                                                alt="Course Images">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="content">
                                        <div class="inner text-start">
                                            <div class="section-title">
                                                <span class="subtitle bg-pink-opacity">Enjoy Learning!</span>
                                            </div>
                                            ...
                                            <h2 class="banner-title">Learn Product in <span class="theme-gradient">16
                                                    weeks</span> with photoshop.</h2>
                        ...
                        <div class="swiper-slide">
                            <div class="row gy-5 row--30 align-items-center">
                                <div class="col-lg-6">
                                    <div class="course-thumbnail">
                                        <a href="course-details.php">
                                            <img class="radius-6" src="assets/images/course/course-online-01.jpg"
                                                alt="Course Images">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="content">
                                        <div class="inner text-start">
                                            ...
                                            <h2 class="banner-title">Learn javascript in <span class="theme-gradient">30
                                                    weeks</span> with jphn due.</h2>
                        ...
                        <div class="swiper-slide">
                            <div class="row gy-5 row--30 align-items-center">
                                <div class="col-lg-6">
                                    <div class="course-thumbnail">
                                        <a href="course-details.php">
                                            <img class="radius-6" src="assets/images/course/course-online-03.jpg"
                                                alt="Course Images">
                                        </a>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="content">
                                        <div class="inner text-start">
                                            ...
                                            <h2 class="banner-title">Learn Design in <span class="theme-gradient">16
                                                    weeks</span> with photoshop.</h2>
    ...
    <div class="rbt-course-area bg-color-white dark-bg-color-white dark-bg-color-white rbt-section-gap">
        <div class="container">
            <div class="row g-5">
                <!-- Start Single Course  -->
    ...
    <!-- Start About Area  -->
    <div class="rbt-about-area bg-color-darker rbt-section-gap">
        <div class="container">
        ...
        <div class="col-lg-7">
            <div class="content radius-6 overflow-hidden">
                <div class="plyr__video-embed rbtplayer">
                    <iframe class="radius-6 overflow-hidden" src="https://www.youtube.com/embed/qKzhrXqT6oE" allowfullscreen
    ...
    <div class="rbt-categories-area bg-color-white dark-bg-color-white rbt-section-gap">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-start">
...
<!-- End Category Box Layout  -->
    ...
    <div class="rbt-brand-area bg-color-white dark-bg-color-white rbt-section-gap">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="section-title text-center mb--40">
                        <span class="theme-gradient d-block small-title w-600 mb--10">Trusted by over 13,400 great
                            teams</span>
    ...
    <div class="rbt-testimonial-area bg-color-white dark-bg-color-white rbt-section-gapBottom">
        <div class="container">
...
<div class="rbt-swiper-arrow rbt-arrow-right">
            ...
            <div class="row mt--30">
                <div class="col-lg-12">
                    <div class="view-more-btn text-center">
                        <a class="rbt-btn-link color-primary" href="#">View More Customer Feedback<i
                                class="feather-arrow-right"></i></a>
                    </div>
                </div>
            </div>
    ...
    <!-- Start Footer aera -->
<footer class="rbt-footer footer-style-1 bg-color-darker overflow-hidden">
