...
<head>
    ...
    <title>Categories - Best Data Analytics Courses in Hyderabad</title>
            ...
            <div class="col-lg-12">
                <div class="breadcrumb-inner text-center">
                    ...
                    <ul class="page-list">
                        ...
                        <li class="rbt-breadcrumb-item active">Categories</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="rbt-cat-box rbt-cat-box-1 variation-2 text-center">
        <div class="inner">
            ...
            <div class="content">
                ...
                <div class="read-more-btn">
                    <a class="rbt-btn-link" href="course-filter-one-toggle.php">35 Courses<i class="feather-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="rbt-cat-box rbt-cat-box-1 variation-2 text-center">
        <div class="inner">
            ...
            <div class="content">
                ...
                <div class="read-more-btn">
                    <a class="rbt-btn-link" href="course-filter-one-toggle.php">20 Courses<i class="feather-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="rbt-cat-box rbt-cat-box-1 variation-2 text-center">
        <div class="inner">
            ...
            <div class="content">
                ...
                <div class="read-more-btn">
                    <a class="rbt-btn-link" href="course-filter-one-toggle.php">15 Courses<i class="feather-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="rbt-cat-box rbt-cat-box-1 variation-2 text-center">
        <div class="inner">
            ...
            <div class="content">
                ...
                <div class="read-more-btn">
                    <a class="rbt-btn-link" href="course-filter-one-toggle.php">50 Courses<i class="feather-arrow-right"></i></a>
                </div>
            </div>
        </div>
    </div>
...
<div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
    <a href="course-filter-one-toggle.php" class="rbt-cat-box rbt-cat-box-1 variation-4 text-center">
        <div class="inner">
            <div class="icons">
    ...
    <div class="rbt-categories-area bg-color-white rbt-section-gap">
        <div class="container">
            ...
            <div class="row g-5">
                <!-- Start Category Box Layout  -->
<div class="col-lg-3 col-md-6 col-sm-6 col-12">
    <a class="rbt-cat-box rbt-cat-box-1 list-style" href="course-filter-one-toggle.php">
        <div class="inner">
            <div class="thumbnail">
    ...
    <div class="rbt-categories-area bg-color-extra2 rbt-section-gap">
        <div class="container">
            ...
            <div class="row g-5">
                <!-- Start Category Box Layout  -->
<div class="col-lg-3 col-md-6 col-sm-6 col-12">
    <a class="rbt-cat-box rbt-cat-box-1 image-overlaping-content" href="course-filter-one-toggle.php">
        <div class="inner">
            <div class="thumbnail">
                <img src="assets/images/category/image/web-design.jpg" alt="Icons Images">
            </div>
...
<!-- Start Category Box Layout  -->
<div class="col-lg-3 col-md-6 col-sm-6 col-12">
    <a href="course-filter-one-toggle.php" class="rbt-cat-box rbt-cat-box-1 image-overlaping-content">
        <div class="inner">
            <div class="thumbnail">
                <img src="assets/images/category/image/personal-development.jpg" alt="Icons Images">
            </div>
    ...
    <div class="rbt-categories-area bg-color-white rbt-section-gap">
        <div class="container">
            ...
            <div class="row g-5">
                <!-- Start Category Box Layout  -->
<div class="col-lg-3 col-md-6 col-sm-6 col-12">
    <a class="rbt-cat-box rbt-cat-box-1 image-overlaping-content on-hover-content-visible" href="course-filter-one-toggle.php">
        <div class="inner">
            <div class="thumbnail">
                <img src="assets/images/category/image/web-design.jpg" alt="Icons Images">
            </div>
...
<!-- Start Category Box Layout  -->
<div class="col-lg-3 col-md-6 col-sm-6 col-12">
    <a href="course-filter-one-toggle.php" class="rbt-cat-box rbt-cat-box-1 image-overlaping-content on-hover-content-visible">
        <div class="inner">
            <div class="thumbnail">
                <img src="assets/images/category/image/personal-development.jpg" alt="Icons Images">
            </div>
...
<!-- End Category Box Layout  -->
    ...
    <div class="rbt-categories-area bg-color-extra2 rbt-section-gap">
        <div class="container">
            ...
            <div class="swiper category-activation-two rbt-arrow-between md-size gutter-swiper-10 ptb--20">
        ...
        <div class="tab-content" id="myCategoryTabContent">
            ...
            <div class="tab-pane fade show active" id="cat-tab-1" role="tabpanel" aria-labelledby="cat-tab-1-tab">
                <div class="rbt-categori-list medium-size flex-wrap justify-content-center">
                    <a href="course-filter-one-toggle.php">Healthcare</a>
                    <a href="course-filter-one-toggle.php">Beauty &amp; fashion</a>
                    <a href="course-filter-one-toggle.php">Education &amp; Travel</a>
                    <a href="course-filter-one-toggle.php">Kitchen</a>
                    <a href="course-filter-one-toggle.php">Medicle &amp; entertain</a>
                    <a href="course-filter-one-toggle.php">Medicle &amp; Science</a>
                    <a href="course-filter-one-toggle.php">Tour &amp; Travel</a>
                </div>
            </div>
