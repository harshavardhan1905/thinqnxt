...
<head>
    ...
    <title>Counter - Best Data Analytics Courses in Hyderabad</title>
            ...
            <div class="col-lg-12">
                <div class="breadcrumb-inner text-center">
                    ...
                    <ul class="page-list">
                        ...
                        <li class="rbt-breadcrumb-item active">Counter</li>
                    </ul>
                </div>
            </div>
        </div>
...
<!-- End Breadcrumb Area -->
    ...
    <!-- Start Single Counter  -->
    <div class="col-lg-3 col-md-6 col-sm-6 col-12">
        <div class="rbt-counterup rbt-hover-active active rbt-hover-03">
            <div class="inner">
    ...
    <!-- Start Single Counter  -->
    <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt--60 mt_md--30 mt_sm--30">
        <div class="rbt-counterup rbt-hover-active rbt-hover-03">
            <div class="inner">
    ...
    <div class="rbt-counterup-area bg_image bg_image_fixed bg_image--3 ptb--170 bg-black-overlay" data-black-overlay="4">
        <div class="conter-style-2">
    <div class="container">
        <div class="row g-5">
            <!-- Start Single Counter  -->
