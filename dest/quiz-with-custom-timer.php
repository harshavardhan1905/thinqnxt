...
<head>
    ...
    <title>Quiz With Custom Timer - Best Data Analytics Courses in Hyderabad</title>
...
<body class="rbt-header-sticky">
        ...
        <div class="accordion" id="accordionExampleb2">
            ...
            <div class="accordion-item card">
                <h2 class="accordion-header card-header" id="headingTwo1">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse" aria-expanded="true"
                        data-bs-target="#collapseTwo1" aria-controls="collapseTwo1">
            ...
            <div class="accordion-item card">
                <h2 class="accordion-header card-header" id="headingTwo4">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse" aria-expanded="true"
                        data-bs-target="#collapseTwo4" aria-controls="collapseTwo4">
            ...
            <div class="accordion-item card">
                <h2 class="accordion-header card-header" id="headingTwo2">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        aria-expanded="false" data-bs-target="#collapseTwo2" aria-controls="collapseTwo2">
                ...
                <div id="collapseTwo2" class="accordion-collapse collapse" aria-labelledby="headingTwo2">
                    <div class="accordion-body card-body">
                        <ul class="rbt-course-main-content liststyle">
                            ...
                            <li><a href="quiz-with-custom-timer.php">
                                    <div class="course-content-left"><i class="feather-help-circle"></i><span
                            ...
                            <li><a href="lesson-quiz-result.php">
                                    <div class="course-content-left"><i class="feather-help-circle"></i><span
                                            class="text">Histudy Quiz
                                            Result</span></div>
                                    <div class="course-content-right"><span class="rbt-check unread"><i
            ...
            <div class="accordion-item card">
                <h2 class="accordion-header card-header" id="headingTwo3">
                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                        aria-expanded="false" data-bs-target="#collapseTwo3" aria-controls="collapseTwo3">
                ...
                <div id="collapseTwo3" class="accordion-collapse collapse" aria-labelledby="headingTwo3">
                    <div class="accordion-body card-body">
                        <ul class="rbt-course-main-content liststyle">
                            ...
                            <li>
                                <a href="lesson-assignments-submit.php">
                                    <div class="course-content-left">
    ...
    <div class="lesson-top-left">
        ...
        <h5>The Complete Histudy 2025: From Zero to Expert!</h5>
    </div>
    <div class="lesson-top-right">
        <div class="rbt-btn-close">
            <a href="course-details.php" title="Go Back to Course" class="rbt-round-btn"><i class="feather-x"></i></a>
        </div>
    </div>
</div>
                <div class="inner">
                    <div class="content">
                        <form id="quiz-form" class="quiz-form-wrapper">
                                    ...
                                    <div class="rbt-lesson-area bg-color-white">
                                        <div class="rbt-lesson-content-wrapper">
                                            <div class="inner py-0">
                                                ...
                                                <button class="rbt-btn btn-gradient hover-icon-reverse mt--30"
                                                    id="next-btn"><span class="icon-reverse-wrapper"><span
                            ...
                            <div id="question-2" class="question">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-lg-6">
                                            <div class="rbt-form-check"><input class="form-check-input" type="radio"
                                                    name="rbt-radio" id="rbt-radio-1"><label class="form-check-label"
                                                    for="rbt-radio-1">Option One</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="rbt-form-check"><input class="form-check-input" type="radio"
                                                    name="rbt-radio" id="rbt-radio-2"><label class="form-check-label"
                                                    for="rbt-radio-2">Option Two</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="rbt-form-check"><input class="form-check-input" type="radio"
                                                    name="rbt-radio" id="rbt-radio-3"><label class="form-check-label"
                                                    for="rbt-radio-3">Option Three</label>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="rbt-form-check"><input class="form-check-input" type="radio"
                                                    name="rbt-radio" id="rbt-radio-4"><label class="form-check-label"
                                                    for="rbt-radio-4">Option Four</label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="rbt-single-quiz mb--80">
                                    ...
                                    <div class="row g-3 mt--10">
                                        <div class="col-lg-12">
                                            <div id="dnd1">
                                                <div
                                                    class="list-group-item d-flex align-items-center gap-4 rbt-course-wrape mb-4 bg-transparent">
                                                    <i class="feather-menu cursor-scroll pe-3 active-icon-white"></i>
                                                    <img class="img-fluid wdt-100"
                                                        src="assets/images/course/course-01.jpg" alt="image">
                                                    <h6 class="rbt-title mb-0">The Complete Histudy 2025: From Zero
                                                        to Expert!</h6>
                                                </div>
                                                <div
                                                    class="list-group-item d-flex align-items-center gap-4 rbt-course-wrape mb-4 bg-transparent">
                                                    <i class="feather-menu cursor-scroll pe-3 active-icon-white"></i>
                                                    <img class="img-fluid wdt-100"
                                                        src="assets/images/course/course-02.jpg" alt="image">
                                                ...
                                                <div
                                                    ...
                                                    <i class="feather-menu cursor-scroll pe-3 active-icon-white"></i>
                                                    <img class="img-fluid wdt-100"
                                                        src="assets/images/course/course-03.jpg" alt="image">
                                ...
                                <div class="submit-btn mt--30"><a class="rbt-btn btn-gradient hover-icon-reverse"
                                        href="#"><span class="icon-reverse-wrapper"><span class="btn-text">Submit
                                                Quiz</span><span class="btn-icon"><i
